...
export class Login extends Component {
  ...
  setEvent() {
    ...
    qs(".login-kakao-login_btn").addEventListener("click", () => {
      window.location =
        "https://kauth.kakao.com/oauth/authorize?client_id=6637eb959da098fc61370452cb5af5d1&redirect_uri=http://localhost:5001/api/auth/kakao/callback&response_type=code";
    });
  }
