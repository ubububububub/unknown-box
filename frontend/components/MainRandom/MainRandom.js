...
export default class MainRandom extends Component {
    ...
    setEvent() {
        const cateImg = [{"의류":"https://cdn-icons-png.flaticon.com/512/2357/2357127.png",
                ...
                qs(".main-catelist").innerHTML += `
                    <li>
                       <a href="/rank?cate=${x.categoryId}">
                         <img src="${cateImg[0][x.categoryName] !== undefined ? cateImg[0][x.categoryName] : cateImg[0]['랜덤']}" />
                       </a>
